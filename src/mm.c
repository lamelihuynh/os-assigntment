...
//       return -1;
//     }
//     int curr_pgn = pgn + pgit; // số trang ảo hiện tại
//     int fpn = curr_frame->fpn; // số trang vật lý hiện tại
//     if( curr_pgn >= PAGING_MAX_PGN){
//       return -1;
//     }
//     //Lấy con trỏ tới Page Table Entry tương ứng
//     uint32_t *pgd = caller->mm->pgd;
//     uint32_t *pte = &pgd[curr_pgn];
//     //Thiết lập PTE cho trang ảo hiện tại
//     pte_set_fpn(pte, fpn);
//     curr_frame->owner = caller->mm;
//     /* Tracking for later page replacement activities (if needed)
//    * Enqueue new usage page */
//     enlist_pgn_node(&caller->mm->fifo_pgn, pgn + pgit);
//     curr_frame = curr_frame->fp_next; // chuyển sang trang vật lý tiếp theo
//   }
